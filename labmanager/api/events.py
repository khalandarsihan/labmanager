    ...
    try:
        ...
        events = frappe.get_all(
            ...
            fields=[
                ...
                "card_image", "detail_hero_image", "is_featured", "is_active"
            ],
            filters={
                "is_active": 1
            },
...
def get_event_details(event_id):
    ...
    try:
        ...
        # Format the response with new image fields
        response = {
            "id": event.name,
            "title": event.title,
            ...
            "detail_hero_image": event.detail_hero_image,
            "is_featured": event.is_featured,
            "is_active": event.is_active,
            "time": event.time or "9:00 AM - 12:00 PM"  # Provide default time if not set
        }
...
def create_event(**kwargs):
    ...
    try:
        ...
        event.card_image = kwargs.get("card_image", "")
        event.detail_hero_image = kwargs.get("detail_hero_image", "")
