          ...
          <div className="md:col-span-2">
            ...
            <div className="w-full">
              <Tabs defaultValue="overview">
                <TabsList className={`w-full grid grid-cols-5 ${useLightTheme ? 'bg-gray-100' : 'bg-gray-800'}`}>
                  <TabsTrigger value="overview" className={`data-[state=active]:${useLightTheme ? 'bg-white' : 'bg-gray-700'}`}>Overview</TabsTrigger>
                  <TabsTrigger value="curriculum" className={`data-[state=active]:${useLightTheme ? 'bg-white' : 'bg-gray-700'}`}>Curriculum</TabsTrigger>
                  <TabsTrigger value="preview" className={`data-[state=active]:${useLightTheme ? 'bg-white' : 'bg-gray-700'}`}>Sample Lesson</TabsTrigger>
                  <TabsTrigger value="outcomes" className={`data-[state=active]:${useLightTheme ? 'bg-white' : 'bg-gray-700'}`}>Outcomes</TabsTrigger>
                  <TabsTrigger value="certificate" className={`data-[state=active]:${useLightTheme ? 'bg-white' : 'bg-gray-700'}`}>Certificate</TabsTrigger>
                </TabsList>
  
                <TabsContent value="overview" className="p-0">
                  <Card className={`mt-0 ${themeStyles.card.bg} ${themeStyles.card.border}`}>
                    <CardHeader>
                        ...
                        {course.syllabus?.map((module) => (
                          <Collapsible key={module.name}>
                            <CollapsibleTrigger className="w-full">
                              <Card className={`border-2 ${useLightTheme ? 'hover:border-blue-200' : 'hover:border-amber-300'} ${themeStyles.card.bg}`}>
                                <CardHeader>
