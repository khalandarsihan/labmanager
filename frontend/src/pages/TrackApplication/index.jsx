...
const handleDocumentUpload = async (documentType, preventTabSwitch = false) => {
  ...
  <div className="flex items-start">
    <AlertCircle className="w-5 h-5 text-purple-500 mt-0.5 mr-2 flex-shrink-0" />
    <div>
      <h3 className="text-purple-700 font-medium mb-1">Document Request</h3>
      ...
      case 'Interview Scheduled':
        return (
          ...
          //   </div>
          // </div>
          <div className="bg-indigo-100 border border-indigo-300 p-4 rounded-lg mb-6">
  <div className="flex items-start">
    <Calendar className="w-5 h-5 text-indigo-500 mt-0.5 mr-2 flex-shrink-0" />
    <div>
      <h3 className="text-indigo-700 font-medium mb-1">Interview Scheduled</h3>
      ...
      case 'Accepted':
        return (
          ...
          //   </div>
          // </div>
          <div className="bg-emerald-100 border border-emerald-300 p-4 rounded-lg mb-6">
          <div className="flex items-start">
            <CheckCircle className="w-5 h-5 text-emerald-500 mt-0.5 mr-2 flex-shrink-0" />
            <div>
              <h3 className="text-emerald-700 font-medium mb-1">Congratulations!</h3>
  ...
  <div className="flex items-start">
    <Clock className="w-5 h-5 text-orange-500 mt-0.5 mr-2 flex-shrink-0" />
    <div>
      <h3 className="text-orange-700 font-medium mb-1">Application Waitlisted</h3>
  ...
  <div className="flex items-start">
    ...
    <div>
      <h3 className="text-red-700 font-medium mb-1">Application Not Approved</h3>
  ...
  return (
    <div className="relative">
      ...
      <div className="max-w-4xl mx-auto py-12 px-4 relative z-10">
        ...
        <div className="bg-white rounded-lg p-6 shadow-md border-4 border-amber-300">
            ...
            <div className="flex gap-4 items-center">
              <div className="relative flex-1">
                <Input
                  value={registrationId}
                  onChange={(e) => setRegistrationId(e.target.value)}
                  // className="pl-10 bg-white border-gray-300 text-gray-800 focus:border-amber-300/50 placeholder-gray-500"
                  className="pl-10 bg-white border-amber-300 border-2 text-gray-800 focus:border-amber-300 placeholder-gray-500"
                  placeholder="Enter your registration ID (e.g., 2025-BCA-0303)"
                />
                <Search className="w-5 h-5 absolute left-3 top-2.5 text-amber-300" />
              </div>
              <Button
                onClick={handleSearch}
                disabled={isSearching}
          ...
          {statusData && (
            <div className="space-y-6">
              {/* Application Summary */}
              <div className="bg-sky-100 text-gray-800 rounded-lg p-4 border border-sky-200 shadow-md">
                ...
                <dl className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
                  <div>
                    <dt className="text-gray-800 text-sm">Application ID</dt>
                    <dd className="flex items-center">
                  ...
                  <div>
                    <dt className="text-gray-800 text-sm">Submission Date</dt>
                    <dd className="flex items-center">
                  ...
                  <div>
                    <dt className="text-gray-800 text-sm">Applicant Name</dt>
                    <dd className="flex items-center">
                  ...
                  <div>
                    <dt className="text-gray-800 text-sm">Program</dt>
                    <dd className="flex items-center">
              ...
              <Tabs defaultValue={activeTab} value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsList className="w-full bg-gray-100 rounded-t-lg border border-gray-300">
                  <TabsTrigger value="timeline" className="text-gray-700 data-[state=active]:bg-amber-300 data-[state=active]:text-gray-900">
                    Timeline
                  </TabsTrigger>
                  <TabsTrigger value="documents" className="text-gray-700 data-[state=active]:bg-amber-300 data-[state=active]:text-gray-900">
                    Documents
                  </TabsTrigger>
                  <TabsTrigger value="interviews" className="text-gray-700 data-[state=active]:bg-amber-300 data-[state=active]:text-gray-900">
                    Interviews
                  </TabsTrigger>
                  <TabsTrigger value="next-steps" className="text-gray-700 data-[state=active]:bg-amber-300 data-[state=active]:text-gray-900">
                    Next Steps
                  </TabsTrigger>
                </TabsList>
                        ...
                        <div className="space-y-4">
                          {statusData.interviews.map((interview, index) => (
                            <div key={index} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                              <div className="flex justify-between items-start mb-3">
                                <h4 className="font-medium text-gray-800">Interview {index + 1}</h4>
                                <Badge className={
                                  interview.status === 'Scheduled' ? 'bg-blue-600' :
                                  interview.status === 'Completed' ? 'bg-emerald-600' :
                                  interview.status === 'Missed' ? 'bg-red-600' :
                              ...
                              {interview.notes && (
                                <div className="mt-3 text-sm text-gray-700 bg-gray-100 p-3 rounded-md">
                                  <MessageSquare className="w-4 h-4 inline-block mr-2 text-amber-500" />
                                  {interview.notes}
                                </div>
                              )}
                    ...
                    <div className="p-6">
                      {statusData.next_steps ? (
                        <div>
                          ...
                          <div className="bg-sky-100 rounded-lg p-4 border border-sky-200 shadow-md text-gray-800 whitespace-pre-line">
                            {statusData.next_steps}
                          </div>
                          
                          {statusData.feedback && (
                            <div className="mt-6">
                              <h4 className="text-md font-semibold text-gray-800 mb-2">Feedback from Admissions Team</h4>
                              <div className="bg-sky-100 rounded-lg p-4 border border-sky-200 shadow-md text-gray-800 whitespace-pre-line">
                                {statusData.feedback}
                              </div>
                            </div>
          ...
          {/* Error Display */}
          {error && !statusData && (
            <div className="bg-red-100 text-red-800 rounded-lg p-4 mt-4 border border-red-300">
              <AlertCircle className="w-5 h-5 inline-block mr-2" />
              {error}
            </div>
          )}
          ...
          {!statusData && !error && (
            <div className="text-center py-8 text-gray-700">
              ...
              <p>Enter your registration ID to check your application status. Your registration ID was provided to you when you submitted your application.</p>
              <p className="mt-2 text-sm text-gray-600">If you've lost your registration ID, please contact our admissions office at admissions@techethica.edu</p>
            </div>
          )}
        </div>
      </div>
