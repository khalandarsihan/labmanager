...
const SearchAndFilters = ({
    ...
    const inputBg = useLightTheme
        ? "bg-white/50 border-purple-200 text-gray-700 placeholder-gray-500"
        : "bg-gray-900/50 border-gray-700 text-gray-200 placeholder-gray-400";
        
    const buttonBg = useLightTheme
        ? "border-purple-200 hover:bg-purple-100/30 text-gray-700"
        : "border-gray-700 hover:bg-gray-700/30 text-gray-200";
    ...
    return (
        <div className="max-w-7xl mx-auto mb-8 px-4 relative z-10">
            <div className={`${containerBg} backdrop-blur-sm border p-6 rounded-lg relative z-10`}>
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div className="relative flex-1">
                        <input
                            ...
                            className={`w-full pl-12 pr-4 py-3 rounded-lg ${inputBg} focus:ring-2 focus:ring-purple-300 focus:border-purple-300`}
                        />
                        <div className="absolute left-4 top-3.5">
                            {isSearching || isDebouncing ? (
                                <div className="w-5 h-5 border-t-2 border-purple-300 rounded-full animate-spin"></div>
                            ) : (
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className={`flex items-center space-x-2 border rounded-lg p-1 ${useLightTheme ? 'border-purple-200' : 'border-gray-700'}`}>
                            <button
