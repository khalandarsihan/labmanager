...
<div className="container mx-auto px-4 py-8">
  {/* Gallery Section - max-w-4xl */}
  {event.gallery && event.gallery.length > 0 && (
    <div className="max-w-4xl mx-auto mb-8">
      <div className={`${themeStyles.card.bg} rounded-lg shadow-md overflow-hidden ${themeStyles.card.border} border`}>
        <EventGallery
...
} rounded-lg shadow-md p-6 mb-6 ${themeStyles.card.border} border`}>
  <h2 className={`text-2xl font-bold mb-4 ${useLightTheme ? 'text-purple-600' : 'text-amber-200'} section-title`}>
    About This Event
  </h2>
  <div className={`prose max-w-none ${useLightTheme ? 'text-gray-800' : 'text-white'}`}>
...
<style jsx>{`
  .theme-highlight {
    color: ${useLightTheme ? '#6b21a8' : '#fcd34d'} !important; /* Purple-800 to Amber-300 */
    transition: color 0.3s ease;
  }
  .section-title {
    color: ${useLightTheme ? '#7e22ce' : '#fcd34d'} !important; /* Purple-700 to Amber-300 */
    transition: color 0.3s ease;
    font-weight: bold;
  }
  .attendee-name {
  ...
  .attendee-item {
    ...
    color: ${useLightTheme ? '#374151' : '#e5e7eb'}; /* Gray-700 to Gray-200 */
    padding: 1rem;
  ...
  .attendee-title {
    font-size: 0.875rem;
    color: ${useLightTheme ? '#4b5563' : '#9ca3af'}; /* Gray-600 to Gray-400 */
  }
  .prose {
    color: ${useLightTheme ? '#374151' : '#ffffff'} !important; /* Ensure prose text is properly colored */
  }
  .prose * {
    color: inherit;
  }
